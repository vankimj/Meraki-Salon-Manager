...
function computeTechSlice(receipts, appointments, techName) {
  ...
  appointments.forEach(a => {
    ...
    serviceCount += (a.services || []).length || 1;
  });

  return { revenue, tips, serviceCount, clientCount: clientIds.size };
}
...
export default function EarningsScreen() {
  ...
  const [data,  setData]  = useState({ revenue: 0, tips: 0, serviceCount: 0, clientCount: 0 });
