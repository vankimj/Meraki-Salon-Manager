...
function download1099Pdf(form, emp, settings) {
  ...
  const payerName = payer.name || settings?.salonName || 'Meraki Nail Studio';
  const payerAddr = payer.address || settings?.salonAddress || 'Columbus, OH';
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  <div class="irs-note">
    ...
    a person who is not your employee must be reported on Form 1099-NEC. Generated by Meraki Salon Manager.
  </div>

  <div class="btn-bar">
    <button onclick="window.print()">⬇ Save / Print PDF</button>
  </div>
  <div class="footer">Meraki Nail Studio · Columbus, OH · Generated ${new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</div>
</body></html>`);
  w.document.close();
}
