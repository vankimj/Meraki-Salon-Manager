...
import { fetchAppointmentsByRange, fetchClients, fetchReviewReceived, fetchReviewRequests } from '../../lib/firestore';
  ...
  return (
    <div style={{ maxWidth: 860, margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
        ...
        {/* Tech leaderboard */}
        <div style={{ background: '#fff', border: '1px solid #e8e8e8', borderRadius: 12, padding: '16px 18px' }}>
          <div style={{ fontSize: 11, fontWeight: 600, color: '#aaa', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: 14 }}>
            By tech
          </div>
